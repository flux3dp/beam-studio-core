...
export const getLayerConfig = (layerName: string) => {
  ...
  const acc = getData(layer, DataType.acc);
...
export const getLayersConfig = (layerNames: string[]) => {
  ...
  const {
    data: power,
    hasMultiValue: hasMultiPower,
  } = getMultiSelectData(layers, DataType.strength);
  const {
    data: repeat,
    hasMultiValue: hasMultiRepeat,
  } = getMultiSelectData(layers, DataType.repeat);
  const {
    data: height,
    hasMultiValue: hasMultiHeight,
  } = getMultiSelectData(layers, DataType.height);
  const {
    data: acc,
    hasMultiValue: hasMultiAcc,
  } = getMultiSelectData(layers, DataType.acc);
  ...
  const {
    data: configName,
    hasMultiValue: hasMultiConfigName,
  } = getMultiSelectData(layers, DataType.configName);
