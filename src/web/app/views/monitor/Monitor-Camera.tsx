...
export default class MonitorCamera extends React.PureComponent<IProps, IState> {
  ...
  constructor(props) {
    ...
    const { model } = device;
    this.isBeamboxCamera = ['mozu1', 'fbm1', 'fbb1b', 'fbb1p', 'fbb2b', 'laser-b1', 'darwin-dev'].includes(model);
    this.state = {
      isHd: false,
    };
  }
