...
const GraycaleSvg = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="12 12 24 24">
    <g transform="translate(16.435 16.071)">
      <path d="M.75.75V16.608H15.88" transform="translate(-0.75 -0.75)" fill="none" stroke="#5b5b5b" strokeLinecap="round" strokeLinejoin="round" stroke-Width="2" />
      <path d="M15.421,1.9v.545a5.328,5.328,0,0,1-5.2,5.449A5.859,5.859,0,0,0,4.509,13.89" transform="translate(-0.916 -0.801)" fill="none" stroke="#969696" strokeLinecap="round" strokeLinejoin="round" stroke-Width="2" />
    </g>
  </svg>
);
