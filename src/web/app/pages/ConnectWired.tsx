      ...
      <div className="connection-wired">
        ...
        <div className="text-container">
          ...
          <div className={classNames('contents', 'what-if', { collapsed: !showCollapse1 })}>
            <div id="collapse-wired1" className="collapse-title" onClick={() => this.setState({ showCollapse1: !showCollapse1 })}>
          ...
          <div className={classNames('contents', 'what-if', { collapsed: !showCollapse2 })}>
            <div id="collapse-wired2" className="collapse-title" onClick={() => this.setState({ showCollapse2: !showCollapse2 })}>
