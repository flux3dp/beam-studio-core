  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Tetapkan daya minimum untuk mode kedalaman.\nPengaturan ini berlaku khusus untuk gambar gradasi saat menggunakan mode kedalaman.',
        pwm_advanced_hint_hexa: 'Jika Anda pengguna Hexa, harap atur daya minimum setidaknya 20%.',
