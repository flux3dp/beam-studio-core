...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Letakkan karton hitam dari kotak aksesori di platform kerja, lalu klik "Berikutnya" untuk melanjutkan proses ukiran.',
    ...
    put_chessboard_desc: 'Silakan letakkan papan catur di tengah area kerja.',
