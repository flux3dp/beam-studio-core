...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      auto_switch_tab: {
        title: 'Automatické přepínání vrstev a panelu objektů',
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        strength: 'Intenzita',
        pwm_advanced_setting: 'Nastavení výkonu pro režim hloubky',
        pwm_advanced_desc: 'Nastavte minimální výkon pro režim hloubky.',
        pwm_advanced_hint: 'Toto nastavení se vztahuje konkrétně na gradientní obrázky při použití režimu hloubky.',
        ...
        repeat: 'Počet průchodů',
        advanced: 'Pokročilý',
        lower_focus: 'Snížit zaostření',
        by: 'o',
        stepwise_focusing: 'Krokové zaostřování',
        single_color: 'Jednobarevný',
        lower_focus_desc: 'Snížení výšky zaostření o určitou vzdálenost po zaostření pro zlepšení výkonu řezání.',
        stepwise_focusing_desc: "Postupné snižování zaostřovací vzdálenosti na základě výšky objektu během každého průchodu.",
        single_color_desc: 'Platí pouze pro plnobarevnou vrstvu a nelze použít s rozšířenou jednobarevnou vrstvou.',
        ...
        preset_management: {
          ...
          add_new: 'Přidat nový',
          lower_focus_by: 'Snížit zaostření o',
          save_and_exit: 'Uložit a ukončit',
          delete: 'Smazat',
          reset: 'Restartovat',
          sure_to_reset: 'Tímto se smažou vaše přizpůsobené parametry a obnoví se všechny předvolby. Jste si jisti, že chcete pokračovat?',
          ...
          import: 'Importovat',
          sure_to_import_presets: 'Tímto se načtou uspořádání předvoleb a přepíší se přizpůsobené parametry. Jste si jisti, že chcete pokračovat?',
          new_preset_name: 'Nový název předvolby',
        },
      },
      object_panel: {
        zoom: 'Zoom',
  ...
  device: {
    ...
    toolhead_change: 'Vyměnit nástrojovou hlavu',
  },
  monitor: {
    monitor: 'MONITOR',
    go: 'Začít',
  ...
  calibration: {
    ...
    moving_laser_head: 'Pohyb laserové hlavy...',
    failed_to_move_laser_head: 'Nepodařilo se přesunout laserovou hlavu.',
    put_chessboard: 'Umístit šachovnici',
    put_chessboard_desc: 'Prosím, umístěte šachovnici do středu pracovního prostoru.',
    put_chessboard_1: 'Prosím, přejděte na ovládací panel stroje a stiskněte AF pro provedení automatického zaostření.',
    put_chessboard_2: 'Prosím, posuňte šachovnicový papír nebo laserovou hlavu, dokud nebude celá šachovnice potvrzena jako uvnitř červeného rámu v okně živého náhledu.',
    failed_to_calibrate_chessboard: 'Nepodařilo se kalibrovat pomocí obrázku šachovnice.',
    perform_autofocus_bb2: 'Prosím, přejděte na ovládací panel stroje a stiskněte AF pro provedení automatického zaostření.',
  },
  ...
  auto_fit: {
    ...
    step1: '1. Umístěte objekt na požadované místo na jednom kusu materiálu.',
    step2: '2. Stiskněte "Potvrdit", abyste zduplikovali objekt na všechny podoPlease perform the camera preview first.bné kusy materiálu v náhledu kamery.',
    preview_first: 'Prosím, nejprve proveďte náhled kamery.',
    failed_to_auto_fit: 'Nepodařilo se automaticky přizpůsobit, prosím zkontrolujte:',
    error_tip1: '1. Je umění umístěno na materiálu správně?',
    error_tip2: '2. Jsou obrysy materiálu dostatečně jasné pro rozpoznání?',
    learn_more: 'Zjistěte, jak funguje automatické přizpůsobení.',
