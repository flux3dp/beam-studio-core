...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_center: 'Τοποθετήστε ένα φύλλο χαρτιού μεγέθους A4 ή επιστολής στο κέντρο του χώρου εργασίας.',
    put_paper_whole_workarea: 'Τοποθετήστε ένα φύλλο χαρτιού για να καλύψετε ολόκληρο τον χώρο εργασίας.',
