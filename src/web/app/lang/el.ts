...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    error_tip1: 'Ελέγξτε ότι υπάρχει αρκετή αντίθεση μεταξύ του υλικού και της περιοχής εργασίας.',
    error_tip2: 'Κάθε κομμάτι υλικού πρέπει να είναι παρόμοιο σε μέγεθος, σχήμα και χρώμα.',
    error_tip3: 'Αποφύγετε αντανακλαστικές ή θολές περιοχές προεπισκόπησης κάμερας.',
