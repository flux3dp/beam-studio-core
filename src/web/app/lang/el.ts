...
const lang: ILang = {
  ...
  beambox: {
      ...
      object_panel: {
        ...
        actions_panel: {
          ...
          ai_bg_removal_reminder:
            'Πατώντας το κουμπί θα χρησιμοποιηθούν αμέσως 0,2 πιστώσεις AI, θέλετε να συνεχίσετε;',
          outline: 'Περίγραμμα',
        },
        path_edit_panel: {
    ...
    object_panels: {
      ...
      text_to_path: {
        font_substitute_pop:
          'Το κείμενο: <strong>%s</strong> περιέχει χαρακτήρες <strong>%s</strong> που δεν υποστηρίζονται από την τρέχουσα γραμματοσειρά: <strong>%s</strong>. <br/>Θέλετε να χρησιμοποιήσετε τη γραμματοσειρά <strong>%s</strong> ως υποκατάστατο;',
  ...
  message: {
    ...
    unavailableWorkarea:
      'Η τρέχουσα περιοχή εργασίας υπερβαίνει την περιοχή εργασίας αυτής της μηχανής. Παρακαλώ ελέγξτε την περιοχή εργασίας της επιλεγμένης μηχανής ή ορίστε την περιοχή εργασίας από Επεξεργασία > Ρυθμίσεις εγγράφου.',
    please_enter_dpi: 'Παρακαλώ εισάγετε τη μονάδα του αρχείου σας (σε mm)',
    auth_error:
      'Σφάλμα έγκρισης: Παρακαλώ ενημερώστε το Beam Studio και το υλικολογισμικό της μηχανής στην πιο πρόσφατη έκδοση.',
    usb_unplugged: 'Η σύνδεση USB έχει χαθεί. Παρακαλώ ελέγξτε τη σύνδεση USB σας',
    uploading_fcode: 'Μεταφόρτωση FCode',
    cant_connect_to_device: 'Αδυναμία σύνδεσης με τη μηχανή, παρακαλώ ελέγξτε τη σύνδεσή σας',
    ...
    unable_to_start:
      'Αδυναμία έναρξης της εργασίας. Παρακαλώ δοκιμάστε ξανά. Αν συμβεί ξανά, επικοινωνήστε μαζί μας με αναφορά σφαλμάτων:',
    camera: {
      ...
      fail_to_transmit_image:
        'Κάτι πήγε στραβά με τη μετάδοση εικόνας. Παρακαλώ επανεκκινήστε το μηχάνημά σας ή το Beam Studio. Αν αυτό το σφάλμα επιμένει, ακολουθήστε τον οδηγό.',
      ws_closed_unexpectly:
        'Η σύνδεση με την κάμερα του μηχανήματος έχει κλείσει απροσδόκητα. Αν αυτό το σφάλμα επιμένει, ακολουθήστε τον οδηγό.',
  ...
  boxgen: {
    ...
    tLength: 'Μήκος T',
    continue_export: 'Συνέχεια στην Εξαγωγή',
