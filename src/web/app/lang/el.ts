...
const lang: ILang = {
  ...
  camera_data_backup: {
    ...
    checking_pictures: 'Έλεγχος εικόνων...',
    no_picture_found: 'Δεν βρέθηκε εικόνα στη μηχανή.',
    select_folder_download: 'Παρακαλούμε επιλέξτε ένα φάκελο για να αποθηκεύσετε τα δεδομένα της κάμερας:',
    select_folder_upload: 'Παρακαλούμε επιλέξτε τον φάκελο που περιέχει τα δεδομένα της κάμερας:',
