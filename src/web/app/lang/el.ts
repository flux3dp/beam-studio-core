...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      auto_switch_tab: {
        title: 'Αυτόματη εναλλαγή μεταξύ πίνακα επιπέδων και αντικειμένων',
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Ρυθμίστε μια ελάχιστη ισχύ για τη λειτουργία βάθους.\nΑυτή η ρύθμιση εφαρμόζεται συγκεκριμένα σε εικόνες κλίσης όταν χρησιμοποιείτε τη λειτουργία βάθους.',
        pwm_advanced_hint_hexa: 'Εάν είστε χρήστης του Hexa, παρακαλώ ρυθμίστε την ελάχιστη ισχύ τουλάχιστον στο 20%.',
