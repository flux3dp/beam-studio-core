...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Τοποθετήστε το χαρτί με το μοτίβο σκακιέρας κάτω από την κεφαλή λέιζερ.',
    put_chessboard_2: 'Χρησιμοποιήστε την προεπισκόπηση ζωντανής εικόνας της κάμερας παρακάτω για να βεβαιωθείτε ότι το χαρτί με το μοτίβο σκακιέρας είναι ευθυγραμμισμένο με το κόκκινο πλαίσιο.',
  },
