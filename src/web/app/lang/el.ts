...
const lang: ILang = {
  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        delete: 'Διαγραφή',
        reset: 'Επαναφορά',
        sure_to_reset: 'Αυτό θα επαναφέρει όλες τις προεπιλογές και θα διατηρήσει τις προσαρμοσμένες παραμέτρους σας, είστε σίγουροι ότι θέλετε να προχωρήσετε;',
        apply: 'Εφαρμογή',
        cancel: 'Ακύρωση',
        save: 'Αποθήκευση',
        ...
        sure_to_load_config: 'Αυτό θα φορτώσει τη διάταξη των προεπιλογών και θα αντικαταστήσει τις προσαρμοσμένες παραμέτρους που ορίζονται στο αρχείο, είστε σίγουροι ότι θέλετε να προχωρήσετε;',
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Παρακαλούμε ευθυγραμμίστε το κέντρο των κόκκινων σημείων σήμανσης με το χαραγμένο κύκλο.',
    ...
    solve_pnp_step3: 'Κάντε κλικ στο "Ολοκληρώθηκε" για να αποθηκεύσετε το αποτέλεσμα της βαθμονόμησης.',
    elevate_and_cut: 'Ανύψωση και Κοπή',
    elevate_and_cut_step_1: 'Παρακαλούμε τοποθετήστε ένα ξύλο φωτεινού χρώματος μεγέθους A4 στο κέντρο του χώρου εργασίας και υψώστε το σε ύψος 20mm.',
    elevate_and_cut_step_1_prism_lift: 'Χρησιμοποιήστε το Ador Prism Lift με το μέγιστο μήκος 14 mm μαζί με ένα ξύλο τουλάχιστον 6 mm πάχους για να υψώσετε το ξύλο σε ύψος 20 mm.',
  ...
  tutorial: {
    ...
    skipped_camera_calibration: 'Παραλείψατε τη βαθμονόμηση της κάμερας. Μπορείτε να βαθμονομήσετε την κάμερα από το μενού.',
    ...
    needNewInterfaceTutorial: 'Θα θέλατε να ξεκινήσετε το εκπαιδευτικό πρόγραμμα για το νέο περιβάλλον;',
    next: 'ΕΠΟΜΕΝΟ',
