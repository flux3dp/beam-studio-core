...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Τοποθετήστε το μαύρο χαρτόνι από το κουτί αξεσουάρ στην πλατφόρμα εργασίας και μετά κάντε κλικ στο "Επόμενο" για να συνεχίσετε με τη χάραξη.',
    ...
    put_chessboard_desc: 'Τοποθετήστε τη σκακιέρα στο κέντρο της περιοχής εργασίας.',
    ...
    put_chessboard_promark_desc_2: 'Βεβαιωθείτε ότι η σκακιέρα είναι τοποθετημένη επίπεδα στην πλατφόρμα εργασίας.',
    put_chessboard_promark: 'Βεβαιωθείτε ότι το χαρτί σκακιέρας είναι καθαρά ορατό χωρίς αντηλιά. Κάντε κλικ στο "Επόμενο" για να τραβήξετε φωτογραφία.',
