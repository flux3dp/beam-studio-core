...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Đặt tấm bìa đen từ hộp phụ kiện lên bàn làm việc, sau đó nhấp vào "Tiếp theo" để tiến hành khắc.',
    ...
    put_chessboard_desc: 'Vui lòng đặt bàn cờ ở trung tâm khu vực làm việc.',
