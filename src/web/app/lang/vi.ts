  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Đặt công suất tối thiểu cho chế độ độ sâu.\nCài đặt này áp dụng cụ thể cho hình ảnh gradient khi sử dụng chế độ độ sâu.',
        pwm_advanced_hint_hexa: 'Nếu bạn là người dùng Hexa, vui lòng đặt công suất tối thiểu ít nhất là 20%.',
