...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: '새겨진 원과 빨간색 마커 포인트의 중심을 맞춰주세요.',
    solve_pnp_step2: '다시 시도를 눌러 마커 위치를 재조정하거나 수동으로 조정할 수 있습니다.',
    solve_pnp_step3: '보정 결과를 저장하려면 "완료"를 클릭하십시오.',
    elevate_and_cut: '들어 올리고 자르기',
    elevate_and_cut_step_1: '작업 영역 중앙에 A4 사이즈의 밝은 색 나무 조각을 놓고 높이를 20mm로 조절하십시오.',
    elevate_and_cut_step_1_prism_lift: '나무를 20mm로 높이기 위해 최대 길이가 14mm인 Ador Prism Lift와 적어도 6mm 두께의 나무를 사용하십시오.',
