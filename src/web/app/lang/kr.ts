...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_desc: '체스보드를 작업 영역의 중앙에 놓아주세요.',
  ...
  material_test_generator: { title: '재질 테스트 생성기', table_settings: '테이블 설정', block_settings: '블록 설정', preview: '미리보기', export: '내보내기', cut: '자르기', engrave: '새기기', columns: '열', rows: '행', parameter: '매개변수', min: '최소', max: '최대', count: '수량', size: '크기 (HxW)', spacing: '간격' },
  web_cam: {
