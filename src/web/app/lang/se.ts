  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Ställ in en minimieffekt för djupinställningar.\nDenna inställning gäller specifikt för gradientbilder när du använder djupinställningar.',
        pwm_advanced_hint_hexa: 'Om du är Hexa-användare, ställ in minimieffekten till minst 20%.',
