...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Placera den svarta kartongen från tillbehörslådan på arbetsplattformen och klicka sedan på "Nästa" för att fortsätta med graveringen.',
