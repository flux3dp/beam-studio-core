...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Vänligen justera mitten av de röda markörpunkterna med den graverade cirkeln.',
    solve_pnp_step2: 'Du kan trycka på "Ta om bild" för att justera om eller justera markörpositionerna manuellt.',
    solve_pnp_step3: 'Klicka på "Klar" för att spara kalibreringsresultatet.',
    elevate_and_cut: 'Lyft och Skär',
    elevate_and_cut_step_1: 'Placera en A4-storlek ljusfärgad träbit i mitten av arbetsytor och höj den till en höjd av 20 mm.',
