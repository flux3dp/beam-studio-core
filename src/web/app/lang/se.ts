...
const lang: ILang = {
  ...
  initialize: {
    ...
    connect_machine_ip: {
      ...
      promark_hint: 'Om du upprepade gånger inte kan ansluta via USB, se <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/11195313944975">Hjälpcentrets artikel</a>.',
      alert: {
  ...
  message: {
    ...
    promark_disconnected: 'Enhetens anslutning har avbrutits, kontrollera enhetens anslutningsstatus.',
  ...
  calibration: {
    ...
    put_paper_promark_2: 'Justera fokuset korrekt och klicka sedan på "Nästa" för att fortsätta med graveringen.',
