...
const lang: ILang = {
  ...
  calibration: {
    ...
    failed_to_calibrate_with_pictures: 'Misslyckades med att kalibrera med enhetsbilder.',
    found_pictures: 'Bilder finns på din enhet. Vill du kalibrera med bilderna?',
