  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Tetapkan kuasa minimum untuk mod kedalaman.\nTetapan ini berlaku khususnya untuk imej kecerunan apabila menggunakan mod kedalaman.',
        pwm_advanced_hint_hexa: 'Jika anda pengguna Hexa, sila tetapkan kuasa minimum kepada sekurang-kurangnya 20%.',
