  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Imposta una potenza minima per il modo profondità.\nQuesta impostazione si applica specificamente alle immagini in gradiente quando si utilizza il modo profondità.',
        pwm_advanced_hint_hexa: 'Se sei un utente Hexa, imposta la potenza minima ad almeno 20%.',
