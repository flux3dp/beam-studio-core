...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Si prega di allineare il centro dei punti di riferimento rossi con il cerchio inciso.',
    solve_pnp_step2: 'È possibile premere "Riprendi immagine" per riallineare o regolare manualmente le posizioni dei marcatori.',
    solve_pnp_step3: 'Fare clic su "Fatto" per salvare il risultato della calibrazione.',
    elevate_and_cut: 'Solleva e Taglia',
    elevate_and_cut_step_1: "Si prega di posizionare un pezzo di legno di colore chiaro di formato A4 al centro dell'area di lavoro e alzarlo a un'altezza di 20 mm.",
    elevate_and_cut_step_1_prism_lift: "Utilizzare Ador Prism Lift con la sua lunghezza massima di 14 mm insieme a un pezzo di legno di almeno 6 mm di spessore per elevare il legno a un'altezza di 20 mm.",
  ...
  tutorial: {
    skip: 'Salta',
    welcome: 'BENVENUTO',
    suggest_calibrate_camera_first: "Si prega di calibrare la fotocamera quando si utilizza la macchina per la prima volta. (Menu > Macchina > [La tua macchina] > Calibra fotocamera) E mettere a fuoco correttamente la piattaforma ogni volta prima dell'anteprima per ottenere un risultato di anteprima migliore.",
    ...
    skipped_camera_calibration: 'Hai saltato la calibrazione della fotocamera. Puoi calibrare la fotocamera in qualsiasi momento dalla barra dei menu (Menu > Macchina > [La tua macchina] > Calibra fotocamera).',
    skipped_ador_calibration: "La fotocamera Ador è stata calibrata durante l'ispezione in fabbrica.",
