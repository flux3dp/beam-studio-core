...
const lang: ILang = {
  ...
  initialize: {
    ...
    connect_machine_ip: {
      ...
      promark_hint: 'Se non riesci a connetterti tramite USB ripetutamente, fai riferimento all\'<a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/11195313944975">articolo del Centro assistenza</a>.',
      alert: {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Posiziona il cartoncino nero dalla scatola degli accessori sulla piattaforma di lavoro, quindi fai clic su "Avanti" per procedere con l\'incisione.',
    ...
    put_chessboard_desc: "Si prega di posizionare la scacchiera al centro dell'area di lavoro.",
