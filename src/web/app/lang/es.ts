...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Por favor, alinee el centro de los puntos de referencia rojos con el círculo grabado.',
    ...
    solve_pnp_step3: 'Haga clic en "Listo" para guardar el resultado de la calibración.',
    elevate_and_cut: 'Elevar y Cortar',
    elevate_and_cut_step_1: 'Coloque un trozo de madera de color claro de tamaño A4 en el centro del área de trabajo y eleve hasta una altura de 20 mm. (También puedes usar Ador Prism Lift con su longitud máxima de 14 mm junto con un trozo de madera de al menos 6 mm de grosor).',
    elevate_and_cut_step_1_prism_lift: 'Utilice Ador Prism Lift con su longitud máxima de 14 mm junto con un trozo de madera de al menos 6 mm de grosor para elevar la madera a una altura de 20 mm.',
    ...
    align_points: 'Por favor, alinee las marcas al centro de los puntos grabados.',
