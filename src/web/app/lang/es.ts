...
const lang: ILang = {
  ...
  topbar: {
    ...
    menu: {
      ...
      tools: {
        ...
        qr_code_generator: 'Generador de Código QR',
  ...
  initialize: {
    ...
    connect_machine_ip: {
      ...
      promark_hint: 'Si no logra conectarse repetidamente a través de USB, consulte el <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/11195313944975">artículo del Centro de ayuda</a>.',
      alert: {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Coloque el cartón negro de la caja de accesorios en la plataforma de trabajo, luego haga clic en "Siguiente" para continuar con el grabado.',
    ...
    put_chessboard_desc: 'Por favor, coloque el tablero de ajedrez en el centro del área de trabajo.',
