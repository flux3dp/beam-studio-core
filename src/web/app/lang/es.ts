  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Establezca una potencia mínima para el modo de profundidad.\nEsta configuración se aplica específicamente a imágenes de gradiente cuando se utiliza el modo de profundidad.',
        pwm_advanced_hint_hexa: 'Si es usuario de Hexa, configure la potencia mínima al menos al 20%.',
