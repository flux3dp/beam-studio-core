...
const lang: ILang = {
  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        speed: 'ความเร็ว',
        speed_contrain_warning: 'ความเร็วการตัดของวัตถุเส้นทางเวกเตอร์จะถูกจํากัดไว้ที่ 20 มม./วินาที คุณสามารถลบขีดจํากัดนี้ออกได้ที่การตั้งค่าการตั้งค่า',
        ...
        delete: 'ลบ',
        reset: 'รีเซ็ต',
        sure_to_reset: 'นี่จะรีเซ็ตการตั้งค่าทั้งหมดและเก็บพารามิเตอร์ที่กําหนดเองไว้ คุณแน่ใจหรือไม่ที่จะดําเนินการต่อ?',
        apply: 'ปรับใช้',
        cancel: 'ยกเลิก',
        save: 'บันทึก',
        ...
        sure_to_load_config: 'นี่จะโหลดการจัดเรียงของการตั้งค่าล่วงหน้าและแทนที่พารามิเตอร์ที่กําหนดเองที่ตั้งไว้ในไฟล์ คุณแน่ใจหรือไม่ที่จะดําเนินการต่อ',
  ...
  message: {
    ...
    monitor_too_old: {
      ...
      content: '#814 โปรดติดตั้งเฟิร์มแวร์ล่าสุดตาม<a target="_blank" href="http://helpcenter.flux3dp.com/hc/en-us/articles/216251077">คู่มือนี้</a>',
    },
  ...
  calibration: {
    ...
    failed_to_calibrate_with_pictures: '#847 การปรับแต่งด้วยภาพอุปกรณ์ล้มเหลว',
    ...
    solve_pnp_step1: 'กรุณาจัดตำแหน่งจุดกึ่งกลางของจุดมาร์คเกอร์สีแดงกับวงกลมที่สลัก.',
    solve_pnp_step2: 'คุณสามารถกด "ถ่ายรูปใหม่" เพื่อจัดตำแหน่งใหม่หรือปรับตำแหน่งของจุดมาร์คเกอร์เองได้.',
    solve_pnp_step3: 'คลิก "เสร็จสิ้น" เพื่อบันทึกผลการแคลิเบรท.',
    elevate_and_cut: 'ยกและตัด',
    elevate_and_cut_step_1: 'ให้วางเฟรมไม้สีสว่างขนาด A4 ไว้ตรงกลางของพื้นที่ทำงานและยกขึ้นไปให้สูง 20 มม.',
    elevate_and_cut_step_1_prism_lift: 'ใช้ Ador Prism Lift ความยาวสูงสุด 14 มม. พร้อมกับไม้ที่มีความหนาอย่างน้อย 6 มม. เพื่อยกไม้ให้สูง 20 มม.',
  ...
  tutorial: {
    ...
    suggest_calibrate_camera_first: 'โปรดปรับเทียบกล้องเมื่อใช้เครื่องครั้งแรก (เมนู > เครื่อง > [เครื่องของคุณ] > ปรับเทียบกล้อง) และปรับโฟกัสแพลตฟอร์มอย่างเหมาะสมทุกครั้งก่อนดูตัวอย่างเพื่อให้ได้ผลลัพธ์ตัวอย่างที่ดีขึ้น',
    camera_calibration_failed: 'การปรับเทียบกล้องล้มเหลว',
    ask_retry_calibration: 'คุณต้องการปรับเทียบกล้องใหม่อีกครั้งหรือไม่?',
    skipped_camera_calibration: 'คุณได้ข้ามการปรับเทียบกล้องแล้ว คุณสามารถปรับเทียบกล้องได้ตลอดเวลาจากเมนู (เมนู > เครื่อง > [เครื่องของคุณ] > ปรับเทียบกล้อง)',
    ...
    needNewInterfaceTutorial: 'คุณต้องการเริ่มตัวช่วยสอนสําหรับอินเทอร์เฟซ Beam Studio ใหม่หรือไม่?',
    next: 'ถัดไป',
