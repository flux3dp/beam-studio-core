...
const lang: ILang = {
  ...
  initialize: {
    ...
    connect_machine_ip: {
      ...
      promark_hint: 'หากไม่สามารถเชื่อมต่อผ่าน USB ซ้ำๆ กรุณาดู <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/11195313944975">บทความในศูนย์ช่วยเหลือ</a>.',
      alert: {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'วางกระดาษแข็งสีดำจากกล่องอุปกรณ์บนแพลตฟอร์มทำงาน จากนั้นคลิก "ถัดไป" เพื่อดำเนินการแกะสลักต่อ',
    ...
    put_chessboard_desc: 'กรุณาวางกระดานหมากรุกไว้ที่ศูนย์กลางของพื้นที่ทำงาน.',
    ...
    put_chessboard_promark_desc_2: 'กรุณาตรวจสอบว่ากระดาษตารางหมากรุกวางอยู่บนพื้นผิวการทำงานอย่างเรียบ',
    put_chessboard_promark: 'กรุณาตรวจสอบให้แน่ใจว่ากระดาษตารางหมากรุกมองเห็นได้ชัดเจนโดยไม่มีแสงสะท้อน คลิก "ถัดไป" เพื่อถ่ายภาพ',
