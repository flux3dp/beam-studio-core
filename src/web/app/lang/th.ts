...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      auto_switch_tab: {
        title: 'สลับชั้นอัตโนมัติและแผงวัตถุ',
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'ตั้งค่ากำลังไฟขั้นต่ำสำหรับโหมดความลึก\nการตั้งค่านี้ใช้กับภาพไล่สีโดยเฉพาะเมื่อใช้โหมดความลึก',
        pwm_advanced_hint_hexa: 'หากคุณเป็นผู้ใช้ Hexa โปรดตั้งค่ากำลังไฟขั้นต่ำอย่างน้อย 20%.',
