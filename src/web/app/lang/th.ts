...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    error_tip1: 'ตรวจสอบให้แน่ใจว่ามีความต่างกันเพียงพอระหว่างวัสดุกับพื้นที่ทำงาน',
    error_tip2: 'ชิ้นวัสดุแต่ละชิ้นต้องมีขนาด รูปร่าง และสีที่คล้ายคลึงกัน',
    error_tip3: 'หลีกเลี่ยงพื้นที่แสดงตัวอย่างกล้องที่สะท้อนแสงหรือพร่ามัว',
