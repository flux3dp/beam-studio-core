...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Plaats het zwarte karton uit de accessoiredoos op het werkplatform en klik vervolgens op "Volgende" om door te gaan met graveren.',
    ...
    put_chessboard_desc: 'Plaats het schaakbord in het midden van het werkgebied.',
