...
const lang: ILang = {
  ...
  topbar: {
    ...
    menu: {
      ...
      image_curve: 'Kromme',
      arrangement_optimization: 'Schikking',
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Lijn het midden van de rode markeringspunten uit met de gegraveerde cirkel.',
    ...
    solve_pnp_step3: 'Klik op "Gereed" om het kalibratieresultaat op te slaan.',
    elevate_and_cut: 'Optillen en Snijden',
    elevate_and_cut_step_1: 'Plaats een A4-formaat lichtgekleurd stuk hout in het midden van het werkgebied en verhoog het tot een hoogte van 20 mm.',
    elevate_and_cut_step_1_prism_lift: 'Gebruik Ador Prism Lift met zijn maximale lengte van 14 mm samen met een stuk hout van minimaal 6 mm dikte om het hout op een hoogte van 20 mm te brengen.',
