...
const lang: ILang = {
  ...
  generic_error: {
    ...
    RESOURCE_BUSY: '[RB] Start de machine opnieuw op of probeer het opnieuw',
  },
  device_selection: {
  ...
  monitor: {
    ...
    confirmGToF: 'De GCode wordt omgezet naar FCode, wil je doorgaan? (zal vervangen indien aanwezig)',
