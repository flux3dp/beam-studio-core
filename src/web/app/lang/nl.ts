  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Stel een minimaal vermogen in voor dieptemodus.\nDeze instelling is specifiek van toepassing op gradiëntafbeeldingen bij gebruik van dieptemodus.',
        pwm_advanced_hint_hexa: 'Als u een Hexa-gebruiker bent, stel het minimale vermogen dan in op minstens 20%.',
