...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: '請將紅框標記點對齊切割出來的圓點。',
    solve_pnp_step2: '您可以按下「重拍照片」以重試對齊或手動調整標記點位置。',
    solve_pnp_step3: '點選「完成」即完成校正。',
    elevate_and_cut: '抬升和切割',
    elevate_and_cut_step_1: '請將 A4 尺寸的淺色木板放在工作區的中央，並將其水平墊高至 20mm 高。',
    elevate_and_cut_step_1_prism_lift: '使用 Ador 刀條的最長邊約 14mm 搭配 6mm 以上木板，將其水平墊高至 20mm 高。',
