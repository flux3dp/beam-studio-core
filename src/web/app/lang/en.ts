  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Set a minimum power for Depth Mode.\nThis setting applies specifically to gradient images when using Depth Mode.',
        pwm_advanced_hint_hexa: 'If you are HEXA user, please set the minimum power to at least 20%.',
