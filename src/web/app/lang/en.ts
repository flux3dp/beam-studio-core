...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Please align the center of the red marker points with the engraved circle.',
    solve_pnp_step2: 'You can press "Retake Picture" to realign or manually adjust the marker positions.',
    solve_pnp_step3: 'Click "Done" to save calibration result.',
    elevate_and_cut: 'Elevate and Cut',
    elevate_and_cut_step_1: 'Please place an A4 size light-colored wooden in the center of the workspace and elevate it to a height of 20mm.',
    elevate_and_cut_step_1_prism_lift: 'Use Ador Prism Lift with its maximum length 14mm along with a wooden at least 6mm thickness to elevate the wooden to a height of 20mm.',
