...
Machines > ‘Promark Name’ > Promark Settings`,
  ...
  message: {
    ...
    promark_disconnected: "Device connection interrupted, please check the device's connection status.",
  ...
  calibration: {
    ...
    put_paper_promark_2: 'Adjust the focus properly, and then click ‘Next’ to proceed with engraving.',
