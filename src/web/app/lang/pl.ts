  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Ustaw minimalną moc dla trybu głębokości.\nTo ustawienie dotyczy konkretnie obrazów gradientowych w trybie głębokości.',
        pwm_advanced_hint_hexa: 'Jeśli jesteś użytkownikiem Hexa, ustaw minimalną moc na co najmniej 20%.',
