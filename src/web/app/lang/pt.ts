  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Defina uma potência mínima para o modo de profundidade.\nEsta configuração aplica-se especificamente a imagens de gradiente ao usar o modo de profundidade.',
        pwm_advanced_hint_hexa: 'Se for um usuário Hexa, defina a potência mínima para pelo menos 20%.',
