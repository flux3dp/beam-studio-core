...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_desc: 'Por favor, coloque o tabuleiro de xadrez no centro da área de trabalho.',
  ...
  curve_engraving: {
    ...
    measure_area_help: 'Como selecionar a área de autofoco para a Curva 3D?',
  ...
  material_test_generator: { title: 'Gerador de Teste de Material', table_settings: 'Configurações de Tabela', block_settings: 'Configurações de Bloco', preview: 'Pré-visualização', export: 'Exportar', cut: 'Cortar', engrave: 'Gravar', columns: 'Colunas', rows: 'Linhas', parameter: 'Parâmetro', min: 'Min', max: 'Máx', count: 'Quantidade', size: 'Tamanho (AxL)', spacing: 'Espaçamento' },
  web_cam: {
