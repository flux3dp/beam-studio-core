...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Coloque o papelão preto da caixa de acessórios na plataforma de trabalho e, em seguida, clique em "Próximo" para continuar com a gravação.',
