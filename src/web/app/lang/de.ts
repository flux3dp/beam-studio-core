...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Bitte richten Sie die Mitte der roten Markierungspunkte mit dem gravierten Kreis aus.',
    ...
    solve_pnp_step3: 'Klicken Sie auf "Fertig", um das Kalibrierungsergebnis zu speichern.',
    elevate_and_cut: 'Anheben und Schneiden',
    elevate_and_cut_step_1: 'Bitte legen Sie ein A4-großes helles Holz in die Mitte des Arbeitsbereichs und heben Sie es auf eine Höhe von 20 mm an.',
    elevate_and_cut_step_1_prism_lift: 'Verwenden Sie Ador Prism Lift mit seiner maximalen Länge von 14 mm zusammen mit einem Holz von mindestens 6 mm Dicke, um das Holz auf eine Höhe von 20 mm zu heben.',
