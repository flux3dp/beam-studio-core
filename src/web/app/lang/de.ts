...
const lang: ILang = {
  ...
  initialize: {
    ...
    connect_usb: {
      ...
      title_sub: ' (Nur HEXA)',
      tutorial1: '1. Verbinden Sie die Maschine mit Ihrem Computer über das USB-Kabel.',
      tutorial2: '2. Klicken Sie auf Nächster.',
    },
    connect_machine_ip: {
  ...
  calibration: {
    ...
    failed_to_download_pictures: '#848 Fehler beim Herunterladen von Bildern',
    ...
    failed_to_calibrate_camera: '#848 Fehler bei der Kamerakalibrierung',
    failed_to_save_calibration_results: '#849 Fehler beim Speichern der Kalibrierungsergebnisse, bitte versuchen Sie es erneut',
