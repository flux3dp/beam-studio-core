...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_center: 'Legen Sie ein Stück A4- oder Letter-Papier in die Mitte des Arbeitsbereichs.',
    put_paper_whole_workarea: 'Legen Sie ein Stück Papier über den gesamten Arbeitsbereich.',
