...
export default {
  ...
  topbar: {
    ...
    alerts: {
      start_preview_timeout: '#803 Beim Starten des Vorschaumodus ist eine Zeitüberschreitung aufgetreten. Bitte starten Sie Ihre Maschine oder Beam Studio neu. Wenn dieser Fehler weiterhin besteht, befolgen Sie <a target="_blank" href="https://flux3dp.zendesk.com/hc/en-us/articles/360001111355">diese Anleitung</a>.',
      fail_to_start_preview: '#803 Fehler beim Starten des Vorschaumodus. Bitte starten Sie Ihre Maschine oder Beam Studio neu. Wenn dieser Fehler weiterhin besteht, befolgen Sie <a target="_blank" href="https://flux3dp.zendesk.com/hc/en-us/articles/360001111355">diese Anleitung</a>.',
      fail_to_connect_with_camera: '#803 Verbindung zur Maschinenkamera konnte nicht hergestellt werden. Bitte starten Sie Ihre Maschine oder Beam Studio neu. Wenn dieser Fehler weiterhin besteht, befolgen Sie <a target="_blank" href="https://flux3dp.zendesk.com/hc/en-us/articles/360001111355">diese Anleitung</a>.',
    ...
    hint: {
      polygon: 'Tasten + / - um Seitenazahl zu erhöhen / zu verringern',
    },
  },
  support: {
    no_webgl: 'WebGL wird nicht unterstützt. Bitte verwenden Sie andere Geräte.',
    no_vcredist: 'Bitte installieren Sie Visual C ++ Redistributable 2015 <br/> Diese kann auf flux3dp.com heruntergeladen werden',
  },
  generic_error: {
    UNKNOWN_ERROR: '[UE] Bitte starten Sie Beam Studio neu',
    OPERATION_ERROR: '[OE] Ein Statuskonflikt ist aufgetreten. Bitte wiederholen Sie die Aktion.',
    SUBSYSTEM_ERROR: '[SE] Fehler beim Ausführen der Aufgabe durch die Maschinenfirmware. Bitte starten Sie die Maschine neu.',
    UNKNOWN_COMMAND: '[UC] Bitte aktualisieren Sie die Geräte-Firmware',
    RESOURCE_BUSY: '[RB] Bitte starten Sie die Maschine neu oder versuchen Sie es erneut',
  },
  device_selection: {
    no_beambox: '#801 Wir können Ihren Computer nicht im Netzwerk finden.\nBefolgen Sie bitte <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001683556">diese Anleitung</a>, um das Verbindungsproblem zu beheben.',
  },
  update: {
    ...
    firmware: {
      ...
      message_pattern_2: '%s Firmware v%s ist jetzt verfügbar - Sie haben v%s.',
      latest_firmware: {
        caption: 'Maschinenfirmware-Update',
        message: 'Sie haben die neueste Maschinenfirmware',
        still_update: 'AKTUALISIEREN',
        cant_get_latest: 'Informationen zur neuesten Firmware konnten nicht abgerufen werden.',
      },
      confirm: 'HOCHLADEN',
    ...
    software: {
      ...
      install_or_not: 'ist bereit für das Update. Möchtest Sie jetzt neu starten und aktualisieren?',
      switch_or_not: 'ist bereit zu wechseln. Möchtest Sie jetzt neu starten und wechseln?',
      available_update: 'Beam Studio v%s ist ab sofort verfügbar, Sie haben v%s. Möchten Sie das Update herunterladen?',
      available_switch: 'Beam Studio v%s ist ab sofort verfügbar, Sie haben v%s. Möchten Sie zu dieser Version wechseln?',
      not_found: 'Sie verwenden die neueste Version von Beam Studio.',
      no_response: 'Fehler beim Herstellen einer Verbindung zum Server. Überprüfen Sie Ihre Netzwerkeinstellungen.',
    ...
    cannot_reach_internet: '#823 Server ist nicht erreichbar <br/> Bitte überprüfen Sie Ihre Internetverbindung',
  ...
  topmenu: {
    ...
    file: {
      label: 'Datei',
      import: 'Importieren',
      save_fcode: 'FLUX-Code exportieren',
      ...
      path_not_exit: 'Dieser Pfad scheint nicht mehr zu existieren.',
    },
    device: {
  ...
  initialize: {
    ...
    connect_wifi: {
      title: 'Verbindung zu W-Lan',
      tutorial1: '1. Gehen Sie zu Touch Panel > Klicken Sie auf "Netzwerk" > "Stellen Sie eine Verbindung zu WiFi her".',
      tutorial2: '2. Wählen Sie Ihr bevorzugtes W-Lan aus und verbinden Sie es.',
      what_if_1: 'Was ist, wenn ich mein W-Lan nicht sehe?',
      what_if_1_content: '1. Der W-Lan-Verschlüsselungsmodus sollte WPA2 oder kein Kennwort sein.\n 2. Der Verschlüsselungsmodus kann in der Administrationsoberfläche des W-Lan-Routers eingestellt werden. Wenn der Router WPA2 nicht unterstützt und Sie Hilfe bei der Auswahl des richtigen Routers benötigen, wenden Sie sich an den FLUX-Support.',
      what_if_2: 'Was ist, wenn ich kein W-Lan sehe??',
      what_if_2_content: '1. Stellen Sie sicher, dass der W-Lan-Dongle vollständig angeschlossen ist.\n 2. Wenn auf dem Touchscreen keine MAC-Adresse des drahtlosen Netzwerks vorhanden ist, wenden Sie sich an den FLUX-Support.\n3. Der W-Lan-Kanal sollte 2.4 GHz betragen (5 GHz werden nicht unterstützt).',
    },
    connect_wired: {
    ...
    connect_ethernet: {
      ...
      tutorial3: '3. Klicken Sie auf "Weiter"',
    },
    connect_machine_ip: {
  ...
  settings: {
    ...
    guess_poke: 'Nach der IP-Adresse des Geräts suchen',
    auto_connect: 'Automatisch die einzige Maschine auswählen',
    ...
    confirm_reset: 'Beam Studio wirklich auf Werkseinstellungen zurücksetzen?',
    language: 'Sprache',
    notifications: 'Desktop-Benachrichtigungen',
    check_updates: 'Auto-Check',
    autosave_enabled: 'Automatisch Speichern',
    autosave_path: 'Automatischs Speichern Speicherort',
    autosave_interval: 'Speichern alle',
    autosave_number: 'Anzahl von automatischem Speichern',
    ...
    simplify_clipper_path: 'Berechneten Pfad Optimieren',
    mask: 'Arbeitsbereich-Ausschnitt',
    text_path_calc_optimization: 'Optimierung der Pfadberechnung',
    font_substitute: 'Nicht unterstützte Zeichen ersetzen',
    default_borderless_mode: 'Offener Boden',
  ...
  beambox: {
    ...
    popup: {
      select_import_method: 'Wählen Sie den Ebenen-Stil:',
      touchpad: 'TouchPad',
      mouse: 'TouchPad',
      layer_by_layer: 'Einzelne Ebenen',
      layer_by_color: 'Ebene nach Farbe',
      nolayer: 'Eine Ebene',
      loading_image: 'Bild laden, bitte warten...',
      no_support_text: 'Beam Studio unterstützt derzeit keine Text-Tags. Bitte übertragen Sie den Text vor dem Importieren in den Pfad.',
      ...
      too_fast_for_path_and_constrain: 'Folgende Ebenen: %s\nenthalten Vektorpfadobjekte und eine Geschwindigkeit von mehr als 20 mm/s \nDie Schnittgeschwindigkeit von Vektorpfadobjekten wird auf 20 mm/s reduziert.\nSie können diese Beschränkung unter den Einstellungen entfernen.',
      should_update_firmware_to_continue: '#814 Ihre Firmware unterstützt diese Version von Beam Studio nicht. Bitte aktualisieren Sie die Firmware, um fortzufahren. (Menü > Maschine > [Ihre Maschine] > Firmware aktualisieren)',
      ...
      select_first: 'Wählen Sie zunächst ein Objekt aus.',
      select_at_least_two: 'Wählen Sie zwei Objekte zum Fortfahren aus.',
      import_file_contain_invalid_path: '#808 Importierte SVG-Datei enthält ungültigen Bildpfad. Bitte stellen Sie sicher, dass alle Bilddateien existieren oder betten Sie das Bild in die Datei ein',
      import_file_error_ask_for_upload: 'Importierte SVG-Datei konnte nicht importiert werden. Sind Sie bereit, dem Entwicklerteam eine Datei für den Fehlerbericht zur Verfügung zu stellen ?',
      ...
      or_turn_off_borderless_mode: ' Oder deaktivieren Sie den Offener Boden Modus.',
      ...
      dxf_version_waring: 'Die Version dieser DXF-Datei ist nicht im 2013 Format (v. 1027), möglicherweise treten Inkompatibilitätsprobleme auf.',
      ...
      dxf_bounding_box_size_over: 'Die Zeichnungsgröße ist außerhalb des Arbeitsbereichs. Bewegen Sie bitte die Zeichnung näher an den Ursprung in Ihrer CAD-Software oder stellen Sie sicher, dass das Gerät richtig eingestellt ist.',
      progress: {
        uploading: 'Lade hoch',
        calculating: 'Berechne',
      },
      backend_connect_failed_ask_to_upload: '#802 Beim Versuch, eine Verbindung zum Server herzustellen, treten immer wieder Fehler auf. Möchten Sie Ihr Fehlerberichtsprotokoll hochladen?',
      pdf2svg: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        multi_layer: 'Mehrere Ebenen',
        parameters: 'Parameter',
        strength: 'Leistung',
        speed: 'Geschwindigkeit',
        speed_contrain_warning: 'Die Schnittgeschwindigkeit von Vektorpfadobjekten wird auf 20mm/s begrenzt. Sie können diese Grenze in den Einstellungen entfernen.',
        repeat: 'Ausführen',
        ...
        name: 'Name',
        default: 'Standard',
        customized: 'Benutzerdefinierte Liste',
        inuse: 'in Benutzung',
        ...
        para_in_use: 'Dieser Parameter ist in Verwendung.',
        do_not_adjust_default_para: 'Standardparameter kann nicht angepasst werden.',
        existing_name: 'Dieser Parametername wird bereits verwendet.',
      },
      object_panel: {
        zoom: 'Zoomen',
        group: 'Gruppieren',
        ...
        option_panel: {
          fill: 'Füllen',
          rounded_corner: 'Abgerundete Ecke',
        ...
        actions_panel: {
          ...
          wait_for_parsing_font: 'Analysiere Schriftart... Bitte warten.',
          offset: 'Abstand',
          array: 'Anordnung',
    ...
    bottom_right_panel: {
      ...
      export_file_error_ask_for_upload: 'Aufgabe konnte nicht exportiert werden. Bist sind Sie bereit, eine Arbeitsszene für die Entwicklung eines Teams für Fehlerberichte bereitzustellen?',
    },
    image_trace_panel: {
      apply: 'Anwenden',
      back: 'Zurück',
    ...
    network_testing_panel: {
      ...
      empty_ip: '#818 Bitte geben Sie zuerst die IP des Zielgeräts ein.',
      start: 'Start',
      end: 'Ende',
      ...
      cannot_connect_2: '#840 Verbindung zur Ziel-IP fehlgeschlagen. Stellen Sie sicher, dass sich das Ziel im selben Netzwerk befindet.',
      ...
      hint_device_often_on_list: 'Die Maschine wird oft nicht auf der Liste gefunden?',
    ...
    layer_color_config_panel: {
      ...
      no_input: 'Bitte geben Sie einen gültigen Hex-Farbcode ein.',
      sure_to_reset: 'Sie verlieren alle benutzerdefinierten Parameter. Sind Sie sicher, dass Sie die Standardeinstellungen wiederherstellen möchten?',
      sure_to_delete: 'Diese Farbeinstellung wirklich löschen?',
    },
    svg_editor: {
      unnsupported_file_type: 'Der Dateityp wird nicht direkt unterstützt. Bitte konvertieren Sie die Datei in SVG oder Bitmap.',
  ...
  noun_project_panel: {
    ...
    export_svg_warning: 'Dieses Projekt enthält Objekte, die durch das Gesetz zum Schutz des geistigen Eigentums geschützt sind. Daher schließt Beam Studio diese Objekte beim Export automatisch aus. Sie können Ihr Projekt weiterhin in Beam-Studio-Datei (.beam-Format) speichern, um alle Daten zu behalten. Möchten Sie dennoch exportieren?',
  ...
  device: {
    ...
    disconnectedError: {
      ...
      message: 'Bitte bestätigen, ob ein Netzwerkzugriff von %s verfügbar ist',
    },
    unknown: 'Unbekannt',
  ...
  monitor: {
    ...
    HARDWARE_ERROR_PUMP_ERROR: '#900 Bitte Wassertank prüfen.',
    HARDWARE_ERROR_DOOR_OPENED: '#901 Tür schliessen, um fortzufahren.',
    HARDWARE_ERROR_OVER_TEMPERATURE: '#902 Überhitzt. Bitte warten Sie einige Minuten.',
    HARDWARE_ERROR_BOTTOM_OPENED: '#903 Boden offen. Bitte Boden einsetzen, um fortzufahren.',
    ...
    forceStop: 'Möchten Sie die laufende Aufgabe abbrechen?',
    upload: 'Hochladen',
    download: 'herunterladen',
    relocate: 'Umziehen',
    cancel: 'Abbrechen',
    prepareRelocate: 'Vorbereitung für Transportsicherung',
  ...
  message: {
    ...
    homing: 'Homing...',
    connectionTimeout: '#805 Zeitlimit für Geräteverbindung. Bitte überprüfen Sie den Zustand Ihres Netzwerks und die W-Lan-Anzeige Ihres Geräts.',
    device_not_found: {
      caption: 'Standard-Maschine nicht gefunden',
      message: '#812 Bitte überprüfen Sie die W-Lan/Wi-Fi-Anzeige Ihres Geräts',
    },
    device_busy: {
    ...
    unknown_device: '#826 Die Verbindung zum Gerät kann nicht hergestellt werden, Bitte stellen Sie sicher, dass USB an das Gerät angeschlossen ist.',
    ...
    need_password: 'Benötige Passwort für die Verbindung mit der Maschine',
    unavailableWorkarea: '#804 Der aktuelle Arbeitsbereich übersteigt den Arbeitsbereich dieser Maschine. Bitte überprüfe den Arbeitsbereich des ausgewählten Geräts oder stellen Sie den Arbeitsbereich über Bearbeiten > Dokumenteinstellung ein.',
    ...
    usb_unplugged: 'Die USB-Verbindung ist verloren gegangen. Bitte überprüfen Sie die USB-Verbindung',
    uploading_fcode: 'FCode hochladen',
    cant_connect_to_device: '#827 Das Gerät konnte nicht angeschlossen werden, bitte überprüfen Sie Ihre Verbindung',
    unable_to_find_machine: 'Maschine konnte nicht gefunden werden',
    disconnected: 'Verbindung instabil, Bitte überprüfen Sie die Geräteverbindung und versuchen Sie es später erneut',
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 Bei der Bildübertragung ist ein Fehler aufgetreten. Bitte starten Sie Ihre Beambox neu oder kontaktieren Sie uns.',
  ...
  camera_calibration: {
    ...
    please_refocus: {
      beambox: 'Stellen Sie die Plattform bitte auf den Brennpunkt ein (die Höhe des umgedrehten Acryls).',
      beamo: 'Stellen Sie den Laserkopf bitte so ein, dass er auf das Gravurobjekt fokussiert (Höhe des umgedrehten Acryls).',
    ...
    analyze_result_fail: 'Konnte das aufgenommene Bild nicht analysieren. <br/> Bitte stellen Sie sicher, dass: <br/>1. Das aufgenommene Bild ist vollständig mit weißem Papier bedeckt.<br/>2. Die Plattform ist richtig fokussiert.',
    ...
    hint_adjust_parameters: 'Verwenden Sie diese Parameter, um das rote Quadrat anzupassen',
  },
  diode_calibration: {
    update_firmware_msg1: 'Ihre Firmware unterstützt diese Funktion nicht. Bitte aktualisieren Sie die Firmware auf v',
    update_firmware_msg2: 'oder höher, um fortzufahren。 (Menü> Maschine> [Ihre Maschine]> Firmware aktualisieren)',
    ...
    please_do_camera_calibration_and_focus: {
      beambox: 'Beim Kalibrieren von Hybrid-Lasermodul wird eine Kamera benötigt\nBitte stellen Sie sicher, dass die Kamera dieser Maschine kalibriert wurde.\nUnd stellen Sie bitte die Plattform auf den Brennpunkt ein (die Höhe des umgedrehten Acryls).',
      beamo: 'Beim Kalibrieren von Hybrid-Lasermodul wird eine Kamera benötigt.\nBitte stellen Sie sicher, dass die Kamera dieser Maschine kalibriert wurde.\nUnd stellen Sie bitte den Laserkopf so ein, dass er auf das Gravurobjekt fokussiert ist (die Höhe des umgedrehten Acryls).',
    },
    please_place_paper: 'Bitte legen Sie ein weißes Papier im A4- oder Letter-Format in die linke obere Ecke des Arbeitsbereichs',
    dx: 'X',
    dy: 'Y',
  ...
  tutorial: {
    ...
    retry: 'Wiederholen',
    newUser: {
      draw_a_circle: 'Zeichnen Sie einen Kreis',
    ...
    tutorial_complete: 'Das ist alles für das Tutorial. Jetzt ist es Zeit kreativ zu sein!',
  },
} as ILang;
