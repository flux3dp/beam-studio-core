...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Legen Sie die schwarze Pappe aus der Zubehörbox auf die Arbeitsplattform, und klicken Sie dann auf "Weiter", um mit dem Gravieren fortzufahren.',
    ...
    put_chessboard_desc: 'Bitte platzieren Sie das Schachbrett in der Mitte des Arbeitsbereichs.',
  ...
  auto_fit: {
    ...
    step1: '1. Platzieren Sie das Objekt in der gewünschten Position auf einem Stück Material.',
    step2: '2. Drücken Sie "Bestätigen", um das Objekt auf alle ähnlichen Stücke Material in der Kamera-Vorschau zu duplizieren.',
