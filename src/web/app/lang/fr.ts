...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Veuillez aligner le centre des points de repère rouges avec le cercle gravé.',
    ...
    solve_pnp_step3: 'Cliquez sur "Terminé" pour enregistrer le résultat de la calibration.',
    elevate_and_cut: 'Élever et Couper',
    elevate_and_cut_step_1: "Veuillez placer un morceau de bois de couleur claire de format A4 au centre de l'espace de travail et le surélever à une hauteur de 20 mm.",
    elevate_and_cut_step_1_prism_lift: "Utilisez Ador Prism Lift avec sa longueur maximale de 14 mm avec un morceau de bois d'au moins 6 mm d'épaisseur pour élever le bois à une hauteur de 20 mm.",
