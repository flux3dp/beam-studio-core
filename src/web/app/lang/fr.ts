...
const lang: ILang = {
  ...
  initialize: {
    ...
    connect_machine_ip: {
      ...
      promark_hint: 'Si vous ne parvenez pas à vous connecter via USB de manière répétée, consultez l\'<a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/11195313944975">article du Centre d\'aide</a>.',
      alert: {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Placez le carton noir de la boîte d\'accessoires sur la plateforme de travail, puis cliquez sur "Suivant" pour continuer la gravure.',
    ...
    put_chessboard_desc: 'Veuillez placer le damier au centre de la zone de travail.',
