...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Aseta lisävarustelaatikon musta kartonki työalustalle, ja napsauta sitten "Seuraava" jatkaaksesi kaiverrusta.',
    ...
    put_chessboard_desc: 'Aseta shakkilauta työalueen keskelle.',
