...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Ole hyvä ja kohdista punaisten merkkipisteiden keskus kaiverretun ympyrän kanssa.',
    solve_pnp_step2: 'Voit painaa "Ota kuva uudelleen" uudelleen suuntautua tai säätää merkkipisteiden sijaintia manuaalisesti.',
    solve_pnp_step3: 'Klikkaa "Valmis" tallentaaksesi kalibrointituloksen.',
    elevate_and_cut: 'Nosta ja Leikkaa',
    elevate_and_cut_step_1: 'Aseta A4-kokoisen vaalean puun keskelle työtilaa ja nosta se 20 mm:n korkeuteen.',
    elevate_and_cut_step_1_prism_lift: 'Käytä Ador Prism Liftiä, jonka maksimipituus on 14 mm, yhdessä vähintään 6 mm paksun puun kanssa, jotta puun korkeus saadaan nostettua 20 mm:iin.',
