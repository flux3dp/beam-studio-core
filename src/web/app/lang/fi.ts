  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Aseta vähimmäisteho syvyystilaan.\nTämä asetus koskee erityisesti liukuvärikuvia käytettäessä syvyystilaa.',
        pwm_advanced_hint_hexa: 'Jos olet Hexa-käyttäjä, aseta vähimmäistehoksi vähintään 20%.',
