...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: '赤いマーカーポイントの中心を刻まれた円と合わせてください。',
    solve_pnp_step2: '「写真を撮り直す」を押してマーカーの位置をリセットするか、手動で調整するか、マーカーポイントを整列してください。',
    solve_pnp_step3: 'キャリブレーション結果を保存するには、「完了」をクリックしてください。',
    elevate_and_cut: '高さを上げて切り取る',
    elevate_and_cut_step_1: 'A4サイズの明るい色の木材を作業領域の中央に置き、高さを20mmにします。',
    elevate_and_cut_step_1_prism_lift: '少なくとも6mmの厚みの木材を、Ador Prism Liftの最大長14mmと一緒に使用する、高さを20mmにします。',
