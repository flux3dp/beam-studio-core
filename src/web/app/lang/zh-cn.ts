...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: '请将红色标记点的中心与雕刻的圆圈对齐。',
    solve_pnp_step2: '您可以按“重拍照片”重新对齐或手动调整标记位置。',
    solve_pnp_step3: '单击“完成”以保存校准结果。',
    elevate_and_cut: '抬升和裁剪',
    elevate_and_cut_step_1: '请将一块A4大小的浅色木材放置在工作区的中心，并将其提升至20mm的高度。(您还可以使用最大长度为14mm的Ador Prism Lift，与至少6mm厚的木材一起使用)。',
    elevate_and_cut_step_1_prism_lift: '使用 Ador Prism Lift，其最大长度为 14mm，再加上至少 6mm 厚度的木材，将木材提升至 20mm 高度。',
