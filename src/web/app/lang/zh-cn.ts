...
const lang: ILang = {
  ...
  initialize: {
    ...
    connect_usb: {
      title: 'USB 连线',
      title_sub: '（仅支援 HEXA）',
      tutorial1: '1. 将您的机器与您的电脑以 USB 线连接。',
      tutorial2: '2. 點選 下一步。',
    },
    connect_machine_ip: {
      check_usb: '确认 USB 连线',
      ...
      laser_panel: {
        ...
        dropdown: {
          ...
          mm: {
            ...
            mdf_3mm_cutting: '密迪板 - 3 mm 切割',
            mdf_5mm_cutting: '密迪板 - 5 mm 切割',
            mdf_engraving: '密迪板 - 刻印',
            ...
            black_acrylic_engraving: '黑色亚克力 - 刻印',
          ...
          inches: {
            ...
            acrylic_engraving: '压克力 - 刻印',
            mdf_3mm_cutting: '密迪板 - 0.1\'\' 切割',
            mdf_5mm_cutting: '密迪板 - 0.2\'\' 切割',
            mdf_engraving: '密迪板 - 刻印',
