...
const lang: ILang = {
  ...
  initialize: {
    ...
    connect_machine_ip: {
      ...
      promark_hint: 'Hvis du gjentatte ganger ikke kan koble til via USB, se <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/11195313944975">Hjelpesenter-artikkelen</a>.',
      alert: {
  ...
  calibration: {
    ...
    put_paper_promark_1: 'Plasser den svarte kartongen fra tilbehørsboksen på arbeidsplattformen, og klikk deretter på "Neste" for å fortsette med graveringen.',
    ...
    put_chessboard_desc: 'Vennligst plasser sjakkbrettet i midten av arbeidsområdet.',
