  ...
  beambox: {
    ...
    right_panel: {
      ...
      laser_panel: {
        ...
        pwm_advanced_desc: 'Sett en minimumseffekt for dybdemodus.\nDenne innstillingen gjelder spesielt for gradientbilder når du bruker dybdemodus.',
        pwm_advanced_hint_hexa: 'Hvis du er Hexa-bruker, vennligst sett minimumseffekten til minst 20%.',
