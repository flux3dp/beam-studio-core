...
const lang: ILang = {
  ...
  calibration: {
    ...
    failed_to_calibrate_with_pictures: 'Kunne ikke kalibrere med enhedens billeder.',
    found_pictures: 'Billeder er fundet på din enhed. Vil du kalibrere med billederne?',
    getting_plane_height: 'Får Højde på Plan...',
    preparing_to_take_picture: 'Forbereder til at tage billede...',
    put_paper: 'Læg papir',
    put_paper_center: 'Placer et stykke A4- eller brevpapir i midten af arbejdsområdet.',
    put_paper_whole_workarea: 'Placer et stykke papir til at dække hele arbejdsområdet.',
    elevate_and_cut: 'Hæv og Skær',
    elevate_and_cut_desc: 'Placer et materiale med en højde på ca. 20 mm i midten af arbejdsområdet.',
