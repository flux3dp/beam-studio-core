...
const lang: ILang = {
  ...
  calibration: {
    ...
    solve_pnp_step1: 'Venligst juster midten af de røde markørpunkter med den graverede cirkel.',
    solve_pnp_step2: 'Du kan trykke på "Tag billede igen" for at justere igen eller manuelt justere markørpositionerne.',
    solve_pnp_step3: 'Klik på "Færdig" for at gemme kalibreringsresultatet.',
    elevate_and_cut: 'Hæv og Skær',
    elevate_and_cut_step_1: 'Venligst placer et A4-størrelse lysfarvet træ i midten af arbejdsområdet og hæv det til en højde på 20 mm.',
    elevate_and_cut_step_1_prism_lift: 'Brug Ador Prism Lift med sin maksimale længde på 14 mm sammen med et træ på mindst 6 mm tykkelse for at hæve træet til en højde på 20 mm.',
    ...
    align_points: 'Venligst juster mærkerne til midten af de graverede punkter.',
