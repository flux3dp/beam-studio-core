...
var svgWhiteList_ = {
  ...
  "g": ['data-ratiofixed', "data-original-layer", 'data-np', 'data-textpath-g', "class", "clip-path", "clip-rule", "id", "display", "fill", "fill-opacity", "fill-rule", "filter", "mask", "opacity", "requiredFeatures", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "style", "systemLanguage", "transform", "font-family", "font-size", "font-style", "font-weight", "text-anchor", "data-color", "data-fullcolor", "data-fixedcolor", "data-speed", "data-lock", "data-strength", 'data-ink', "data-repeat", "data-diode", "data-height", "data-zstep", 'inkscape:label', 'data-configName', 'data-tempgroup', 'data-module', 'data-backlash', 'data-multipass', 'data-uv', 'data-printingSpeed'],
  "image": ['data-ratiofixed', "data-shading", "data-threshold", "data-original-layer", "data-fullcolor", 'display-fullcolor', "class", "clip-path", "clip-rule", "filter", "height", "id", "mask", "opacity", "requiredFeatures", "style", "systemLanguage", "transform", "width", "x", "xlink:href", "xlink:title", "y"],
